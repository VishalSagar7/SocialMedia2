...
export const followOrUnfollow = async (req, res) => {
    try {
        ...
        if (isFollowing) {
            ...
            const updatedUser = await User.findById(folllowKarneWala);
            const updatedJiskoFollowKarunga = await User.findById(jiskoFollowKarunga).populate('posts');
