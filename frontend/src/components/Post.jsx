...
const Post = ({ post }) => {
    ...
    const [isAlreadyBoookmarked, setIsAlreadyBookmarked] = useState(user.bookmarks.includes(post?._id));

    // console.log('isBookmarkded' , isAlreadyBoookmarked);
    ...
    const bookMarkHandler = async (postId) => {
        try {
            ...
            setIsAlreadyBookmarked(!isAlreadyBoookmarked);
        }
    }
